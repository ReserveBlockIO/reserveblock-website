    ...
    <Section fill={true} center={true} id="learn">
      <div>
        ...
        <div className="container">
          ...
          <SectionHeading2>Evolving the Future Today</SectionHeading2>
            ...
            <div className="row mt-4">
              <div className="col">
                <p className="">
                  ...
                  friction and highly efficient, all through a core wallet that
                  has yet to be experienced before! Bottom line, true utility &
                  scalability for NFTs that YOU control, store, and own period.
                </p>
              </div>
            </div>
          </SectionContent>
